...
const translations = {
  'zh-CN': {
    ...
    'hint.quickPanel': '选中文字后自动显示翻译按钮',
    'hint.hover': '按住 Alt 键并将鼠标悬停在文字上，无需选中即可翻译',
    'hint.inline': '选中网页文字后自动翻译，结果浮窗显示在选区附近，点击顶部关闭',
    ...
    'btn.modules': '模块系统',
    'settings.modules': '模块系统',
    'module.empty': '暂无模块',
    'module.active': '活跃',
    'module.import': '导入模块',
    'module.name.engine-google': 'Google 翻译',
    'module.name.engine-microsoft': 'Microsoft 翻译',
    'module.name.engine-glm': 'GLM 大模型',
    'module.name.engine-custom': '自定义 LLM',
    'module.name.mode-quick-panel': '划词翻译',
    'module.name.mode-float-panel': '浮动翻译面板',
    'module.name.mode-inline-translate': '选词即译',
    'module.name.processor-sanitizer': '文本净化',
    'module.name.processor-code-protector': '代码保护',
    'module.name.service-translation-cache': '翻译缓存',
    'module.type.translator': '翻译引擎',
    'module.type.mode': '交互模式',
    'module.type.renderer': 'UI 渲染',
    'module.type.processor': '处理器',
    'module.type.service': '服务',
    'module.type.theme': '主题',
  ...
  'zh-TW': {
    ...
    'hint.quickPanel': '選中文字後自動顯示翻譯按鈕',
    'hint.hover': '按住 Alt 鍵並將滑鼠懸停在文字上，無需選中即可翻譯',
    'hint.inline': '選中網頁文字後自動翻譯，結果浮窗顯示在選區附近，點擊頂部關閉',
    ...
    'btn.modules': '模組系統',
    'settings.modules': '模塊系統',
    'module.empty': '暫無模塊',
    'module.active': '活躍',
    'module.import': '導入模組',
    'module.name.engine-google': 'Google 翻譯',
    'module.name.engine-microsoft': 'Microsoft 翻譯',
    'module.name.engine-glm': 'GLM 大模型',
    'module.name.engine-custom': '自訂 LLM',
    'module.name.mode-quick-panel': '划詞翻譯',
    'module.name.mode-float-panel': '浮動翻譯面板',
    'module.name.mode-inline-translate': '選詞即譯',
    'module.name.processor-sanitizer': '文字淨化',
    'module.name.processor-code-protector': '程式碼保護',
    'module.name.service-translation-cache': '翻譯快取',
    'module.type.translator': '翻譯引擎',
    'module.type.mode': '交互模式',
    'module.type.renderer': 'UI 渲染',
    'module.type.processor': '處理器',
    'module.type.service': '服務',
    'module.type.theme': '主題',
  ...
  'en': {
    ...
    'hint.inline': 'Auto-translate selected text, result window near selection, click header to close',
    ...
    'btn.modules': 'Module System',
    'settings.modules': 'Modules',
    'module.empty': 'No modules',
    'module.active': 'Active',
    'module.import': 'Import Module',
    'module.name.engine-google': 'Google Translate',
    'module.name.engine-microsoft': 'Microsoft Translator',
    'module.name.engine-glm': 'GLM',
    'module.name.engine-custom': 'Custom LLM',
    'module.name.mode-quick-panel': 'Selection Translate',
    'module.name.mode-float-panel': 'Float Panel',
    'module.name.mode-inline-translate': 'Select-to-Translate',
    'module.name.processor-sanitizer': 'Text Sanitizer',
    'module.name.processor-code-protector': 'Code Protector',
    'module.name.service-translation-cache': 'Translation Cache',
    'module.type.translator': 'Translator',
    'module.type.mode': 'Mode',
    'module.type.renderer': 'Renderer',
    'module.type.processor': 'Processor',
    'module.type.service': 'Service',
    'module.type.theme': 'Theme',
  ...
  'ja': {
    ...
    'hint.inline': 'テキスト選択後に自動翻訳、結果を選択範囲近くに表示、ヘッダークリックで閉じる',
    ...
    'btn.modules': 'モジュールシステム',
    'settings.modules': 'モジュール',
    'module.empty': 'モジュールなし',
    'module.active': 'アクティブ',
    'module.import': 'モジュールをインポート',
    'module.name.engine-google': 'Google翻訳',
    'module.name.engine-microsoft': 'Microsoft翻訳',
    'module.name.engine-glm': 'GLM',
    'module.name.engine-custom': 'カスタムLLM',
    'module.name.mode-quick-panel': '選択翻訳',
    'module.name.mode-float-panel': 'フロートパネル',
    'module.name.mode-inline-translate': '選択即翻訳',
    'module.name.processor-sanitizer': 'テキスト整形',
    'module.name.processor-code-protector': 'コード保護',
    'module.name.service-translation-cache': '翻訳キャッシュ',
    'module.type.translator': '翻訳エンジン',
    'module.type.mode': 'モード',
    'module.type.renderer': 'レンダラー',
    'module.type.processor': 'プロセッサー',
    'module.type.service': 'サービス',
    'module.type.theme': 'テーマ',
  ...
  'ko': {
    ...
    'hint.inline': '텍스트 선택 후 자동 번역, 결과 창이 선택 영역 근처에 표시, 헤더 클릭으로 닫기',
    ...
    'module.empty': '모듈 없음',
    'module.active': '활성',
    'module.import': '모듈 가져오기',
    'module.name.engine-google': 'Google 번역',
    'module.name.engine-microsoft': 'Microsoft 번역',
    'module.name.engine-glm': 'GLM',
    'module.name.engine-custom': '사용자 정의 LLM',
    'module.name.mode-quick-panel': '선택 번역',
    'module.name.mode-float-panel': '플로트 패널',
    'module.name.mode-inline-translate': '선택즉번역',
    'module.name.processor-sanitizer': '텍스트 정리',
    'module.name.processor-code-protector': '코드 보호',
    'module.name.service-translation-cache': '번역 캐시',
    'module.type.translator': '번역 엔진',
    'module.type.mode': '모드',
    'module.type.renderer': '렌더러',
    'module.type.processor': '프로세서',
    'module.type.service': '서비스',
    'module.type.theme': '테마',
