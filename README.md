...
<p align="center">
  <strong>🧩 模块化浏览器翻译插件 · 所有功能由模块系统统一管理 · 自由开关、按需扩展</strong>
</p>
...
QuickTranslate 3.0 引入完整的模块生态。**所有功能都是模块**——划词翻译、悬浮翻译、选词即译、翻译引擎、文本处理器、后台服务，全部由模块系统统一管理。用户可以在 🧩 模块系统中自由开关每个模块，无需在多个设置页面之间切换。
...
```bash
powershell -File build-release.ps1 -Version "3.3.0"
```
...
<p align="center">
  Made with ❤️ by <a href="https://github.com/kany2000">kany2000</a> · QuickTranslate v3.3.0
</p>