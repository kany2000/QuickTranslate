...
if (result && result !== text) {
  ...
  // --- Task B (Stage 4): UI/overlay engine extracted to content-ui.js ---
  }
  ...
  // --- Task B (Stage 4): mount extracted UI/overlay rendering engine ---
  if (typeof window.UIMethods !== 'undefined') {
    const uiProto = window.UIMethods.prototype;
    for (const name of Object.getOwnPropertyNames(uiProto)) {
      if (name === 'constructor') continue;
      Object.defineProperty(
        ScreenshotCapture.prototype,
        name,
        Object.getOwnPropertyDescriptor(uiProto, name)
      );
    }
  }
